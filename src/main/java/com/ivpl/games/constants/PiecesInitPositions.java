...
/*    public static final Map<Long, Integer[]> checkersInitPositions = Map.ofEntries(
    ...
    public static final Map<Long, Integer[]> chessInitPositions = Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(23L, new Integer[]{5, 8}),
            new AbstractMap.SimpleEntry<>(24L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(25L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(26L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(27L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(28L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(29L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(30L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(31L, new Integer[]{7, 8}),
            new AbstractMap.SimpleEntry<>(32L, new Integer[]{7, 8})
    );
